...
namespace
{
  ...
  TEST(IdealGasEOS, ConservativeFromPrimitive)
  {
    ...
    const auto conservative =
      IdealGasEOS::conservative_from_primitive<dim, ConservativeState>(primitive, material);
  ...
  TEST(StiffenedGasEOS, ConservativeFromPrimitive)
  {
    ...
    const auto conservative =
      StiffenedGasEOS::conservative_from_primitive<dim, ConservativeState>(primitive, material);
  ...
  TEST(NobleAbelStiffenedGasEOS, ConservativeFromPrimitive)
  {
    ...
    const auto conservative =
      NobleAbelStiffenedGasEOS::conservative_from_primitive<dim, ConservativeState>(primitive,
                                                                                    material);
